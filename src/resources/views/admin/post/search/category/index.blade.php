                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Post searching [by category]</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="content">
                                        <p class="float-right">*by categories</p><br>
                                            <form id="searchForm1" class="search-form" action="{{ route('admin.post.category.search.find') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
